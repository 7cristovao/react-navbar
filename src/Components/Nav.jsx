...
const Nav = () => {
    ...
    <div className="lg:hidden block absolute top-16 w-full left-0 right-0 bg-slate-900 transition">
        <ul className="text-center text-x1 p-20">
            ...
            <Link spy={true} smooth={true} to="Serviços">
                <li className="my-4 py-4 border-b border-slate-800 hover:bg-slate-800 hover:rounded">Serviços</li>
            </Link>
            <Link spy={true} smooth={true} to="Projetos">
                <li className="my-4 py-4 border-b border-slate-800 hover:bg-slate-800 hover:rounded">Projeto</li>
            </Link>
                ...
                <div className="lg:flex md:flex lg: flex-1 items center justify-end font-normal hidden">
                    <div className="flex-10">
                        <ul className="flex gap-8 mr-16 text-[18px]">
                            ...
                            <Link spy={true} smooth={true} to="Serviços">
                                <li className="hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer">Serviços</li>
                            </Link>
                            <Link spy={true} smooth={true} to="Projeto">
